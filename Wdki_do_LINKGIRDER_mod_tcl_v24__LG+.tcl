...
ABM BEGIN
	...
	CALC BEGIN
		...
		TABLE      "CrossBeam_BeginEnd" ""
		TABLE      "CrossBeam_Middle" ""
		...
		CURVE "CrossBeam_BeginEnd"   CONSTX   CONSTY BEGIN
		...
		CURVE "CrossBeam_Middle"   CONSTX   CONSTY BEGIN
	...
	CSECTIONS BEGIN
		...
		CSECTION "wd185_with_road" BEGIN
			...
			CGREF BEGIN
				...
				POINT       "P1"      LSECT     "dol pop" "L7"
				POINT       "P2"      LSECT     "dol pop" "L14"
		...
		CSECTION "wd185_zpop" BEGIN
			...
			CBOUNDARIES BEGIN
				...
				BOUNDARY "Boundary 7" BEGIN
					
					POINTS BEGIN
						
						BPOINT       1  LSECT   "dol pop" "L7"
						BPOINT       2  LSECT   "L7"    "gora plyty"
						BPOINT       3  LSECT   "L14"   "gora plyty"
						BPOINT       4  LSECT   "dol pop" "L14"
		...
		CSECTION "CrossBeam" BEGIN
			
			TEXT   ""
			
			CVARS BEGIN
				
				VAR         "Var1"                     1.30000  LENGTH  ""
				VAR         "Var2"                     0.70000  LENGTH  ""
			...
			CLINES BEGIN
				...
				PARALLEL    "L1"           "Var1"         POS  LINE   "Zloc"
				PARALLEL    "L2"           "Var2"         POS  LINE   "Yloc"
				PARALLEL    "L3"           "Var2"         NEG  LINE   "Yloc"
				RELFACT     "L4"                0.50000        LINE    "L1"    LINE    "Zloc"
			...
			CBOUNDARIES BEGIN
				...
				BOUNDARY "Boundary 1" BEGIN
					...
					POINTS BEGIN
						...
						BPOINT       1  LSECT   "L2"    "Zloc"
						BPOINT       2  LSECT   "L1"    "L2"
						BPOINT       3  LSECT   "L1"    "L3"
						BPOINT       4  LSECT   "L3"    "Zloc"
	...
	STRUCTURE BEGIN
		...
		GIRDER "Girder 1" BEGIN
			...
			SPOINT            s001              CSECTION   "" "wd185_with_road"
			SPOINT      [XFTS s002   s026   1]  CSECTION   "wd185_with_road"
			SPOINT            s027              CSECTION   "wd185_with_road" ""
			
			SPOINT      [XFTS s001   s003   1]  ZROTATE    0.00000   STRETCH
			SPOINT      [XFTS s004   s012   1]  ZROTATE    0.00000
			...
			SPOINT            s003              VARIABLE   "wyszerzenieDZ" ""                   "tab_wyszerz(\$sr)"
			SPOINT      [XFTS s004   s024   1]  VARIABLE   "wyszerzenieDZ" "tab_wyszerz(\$sr)"
			SPOINT            s025              VARIABLE   "wyszerzenieDZ" "tab_wyszerz(\$sr)"  ""
			...
			SPOINT      [XFTS s001   s026   1]  MATERIAL   "3"          "EN:C40/50"
			SPOINT      [XFTS s001   s026   1]  MATERIAL   "4"          "EN:C40/50"
		...
		LGIRDER "CrooBeamBeginEnd" TEMPLATE BEGIN
			...
			STATIONS BEGIN
				...
				SXTOL  s001            0.000000    BEAM
				SXTOL  s002            0.500000    BEAM
				SXTOL  s003            1.000000    BEAM
				
			STATIONS END
			
			SPOINT            s001              CSECTION   "" "CrossBeam"
			SPOINT      [XFTS s002   s003   1]  CSECTION   "CrossBeam"
			
			
			SPOINT            s001              YROTATE   -8.36316   STRETCH
			SPOINT            s003              YROTATE    8.49240   STRETCH
			
			SPOINT            s001              VARIABLE   "Var1"       ""                      "CrossBeam_BeginEnd(\$sl)"
			SPOINT      [XFTS s002   s003   1]  VARIABLE   "Var1"       "CrossBeam_BeginEnd(\$sl)"
			
			SPOINT      [XFTS s001   s002   1]  MATERIAL   "1"          "EN:C40/50"
			
			SPOINT      [XFTS s001   s002   1]  GROUP      "1"          ""
			
		LGIRDER END
		
		LGIRDER "CrossBeamMiddle" TEMPLATE BEGIN
			...
			SPOINT            s001              YROTATE   -8.32948   STRETCH
			SPOINT            s003              YROTATE    8.52738   STRETCH
			
			SPOINT            s001              VARIABLE   "Var1"       ""                      "CrossBeam_Middle(\$sl)"
			SPOINT      [XFTS s002   s003   1]  VARIABLE   "Var1"       "CrossBeam_Middle(\$sl)"
			SPOINT            s001              VARIABLE   "Var2"       ""                      "0.35"
			SPOINT      [XFTS s002   s003   1]  VARIABLE   "Var2"       "0.35"
		...
		LGIRDER "CrossBeamBegin" BEGIN
			
			TEXT            ""
			TEMPLATE        "CrooBeamBeginEnd"
			LENGTH             3.2938
			...
			STATIONS BEGIN
				...
				SXTOL  s002            0.500000    TEMPLATE
				SXTOL  s003            1.000000    TEMPLATE
				
			STATIONS END
			
			SPOINT      [XFTS s001   s003   1]  NODE       "1"            1602   STEP     1
			
			SPOINT      [XFTS s001   s002   1]  BEAM       "1"            1602   STEP     1
			
		LGIRDER END
		
		LGIRDER "CrossBeamEnd" BEGIN
			...
			SPOINT      [XFTS s001   s003   1]  NODE       "1"            1605   STEP     1
			
			SPOINT      [XFTS s001   s002   1]  BEAM       "1"            1604   STEP     1
			
		LGIRDER END
		
		LGIRDER "CrossBeamMidd" BEGIN
			
			TEXT            ""
			TEMPLATE        "CrossBeamMiddle"
			LENGTH             2.7358
			EXCEED            -0.0210      0.0210
			...
			SPOINT      [XFTS s001   s003   1]  NODE       "1"            1608   STEP     1
			
			SPOINT      [XFTS s001   s002   1]  BEAM       "1"            1606   STEP     1
		...
		GPOSITIONS BEGIN
			...
			LINK2SMEM   "CrossBeamBegin" BACK   CGREF   "Girder 1"      s002    BACK    "P2"
			LINK2SMEM   "CrossBeamBegin" FRONT  CGREF   "Girder 1"      s002    BACK    "P1"
			LINK2SMEM   "CrossBeamEnd"  BACK    CGREF   "Girder 1"      s026    BACK    "P1"
			LINK2SMEM   "CrossBeamEnd"  FRONT   CGREF   "Girder 1"      s026    BACK    "P2"
			LINK2SMEM   "CrossBeamMidd" BACK    CGREF   "Girder 1"      s014    BACK    "P2"
			LINK2SMEM   "CrossBeamMidd" FRONT   CGREF   "Girder 1"      s014    BACK    "P1"
		...
		CONNECTIONS BEGIN
			...
			RIGID       "CrossBeamBegin" s001      FRONT "1" TO   "Girder 1"    s002    BACK  "2"
			RIGID       "CrossBeamBegin" s003      BACK "1" TO   "Girder 1"     s002    BACK  "1"
			RIGID       "CrossBeamEnd"  s003       BACK "1" TO   "Girder 1"     s026    BACK  "2"
			RIGID       "CrossBeamEnd"  s001       FRONT "1" TO   "Girder 1"    s026    BACK  "1"
			RIGID       "CrossBeamMidd" s001       FRONT "1" TO   "Girder 1"    s014    BACK  "2"
			RIGID       "CrossBeamMidd" s003       BACK "1" TO   "Girder 1"     s014    BACK  "1"
	...
	CONSTRUCTION "Construction 1" BEGIN
		...
		PHASE "structure activation" BEGIN
			...
			ASSEMBLIES BEGIN
				...
				ASM        2  MEMBER    "CrossBeamBegin" UNIT  * SGLOBAL   *              SGLOBAL   *
				ASM        2  MEMBER    "CrossBeamEnd" UNIT  *   SGLOBAL   *              SGLOBAL   *
				ASM        2  MEMBER    "CrossBeamMidd" UNIT  *  SGLOBAL   *              SGLOBAL   *
